...
java -jar -Xmx${ENV_MEM_JVM} /home/tester/sources/burp-rest-api-2.1.0.jar --address=0.0.0.0 --port=8090  --headless.mode=false --unpause-spider-and-scanner --burp.jar=BurpLoader.jar 
