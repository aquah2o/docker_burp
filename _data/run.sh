...
chmod 777 burp-rest-api-2.0.1.jar
...
#    ./burp-rest-api.sh --headless.mode=true --address=0.0.0.0 --port=8090  --unpause-spider-and-scanner --config-file="burpsettings.json"
java -jar -Xmx${ENV_MEM_JVM} /home/tester/sources/burp-rest-api-2.0.1.jar --address=0.0.0.0 --port=8090  --headless.mode=true --unpause-spider-and-scanner --burp.jar=-cp BurpLoader.jar:burpsuite_pro.jar larry.lau.BurpLoader 
