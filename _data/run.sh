...
if [ "$ENV_BURP_PRO" -eq "1" ]; then
    ...
    java -jar -Xmx${ENV_MEM_JVM} /home/tester/sources/burp-rest-api-2.0.1.jar --address=0.0.0.0 --port=8090 --headless.mode=false  --burp.jar=/home/tester/sources/burp_pro.jar --unpause-spider-and-scanner
